...
const StickyNote = ({title, bulletOne = "", bulletTwo = "", bulletThree = "", scale, rotation, posY, posX, onClick}) => {
  ...
  return (
    <div className={`relative w-[16em] h-[16em] p-[5px] m-[1rem] bg-yellow-200 text-black shadow-lg shadow-black rounded-md transition-all duration-300 transform ${
            ...
            style={{scale: isHovered ? `${scale}` : "", transform: isHovered ? `rotate(${rotation})` : "rotate(0deg)", top: posY, left: posX}}
