    ...
    <div>
      <Main>
          ...
          <section className="flex flex-col m-[2rem]">
            ...
            <p className="mx-[1rem] text-ivory">This is a Background Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cumque officiis temporibus, impedit voluptatum, quaerat totam recusandae cupiditate laboriosam mollitia eveniet at nemo sed quis sit dolore. Facere fuga dicta doloremque.</p>
          </section>
          <section className="flex flex-col m-[2rem]">
            <h2 className="font-bold underline text-2xl">The Questions:</h2>
            <li className="ml-[2rem] text-ivory">Question1</li>
            <li className="ml-[2rem] text-ivory">Question2</li>
            <li className="ml-[2rem] text-ivory">Question3</li>
            <li className="ml-[2rem] text-ivory">Question4</li>
          </section>
          <section className="flex flex-col m-[2rem]">
            <h2 className="font-bold underline text-2xl">Data Sourcing:</h2>
            <p className="mx-[1rem] text-ivory">Description of data source</p>
          </section>
          <section className="flex flex-col m-[2rem]">
            <h2 className="font-bold underline text-2xl">Data Cleaning:</h2>
            <p className="mx-[1rem] text-ivory">Description of cleaning</p>
          </section>
          <section className="flex flex-col m-[2rem]">
            ...
            <p className="mx-[1rem] text-ivory">explanation of graphs, cats are cool</p>
          </section>
          <section className="flex flex-col m-[2rem]">
