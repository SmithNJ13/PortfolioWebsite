...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <section>
        {complete && <Link to={"home"} onClick={() => localStorage.setItem("firstVisit", false)}><button className="w-[8rem] h-auto mt-[2rem] font-bold text-2xl text-lightemerald border-b-[1px] hover:text-white">E N T E R</button></Link>}
      </section>
    </main>
    </>
  );
